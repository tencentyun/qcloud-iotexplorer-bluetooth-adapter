...
export const StandardDeviceAdapterFactory = (_DeviceAdapter: typeof DeviceAdapter) => {
  ...
  return (
    class StandardDeviceAdapter extends _DeviceAdapter {
